...
import { updateInstitutionsCache } from "@/src/actions/institutions";
import { updateExchangeRatesCache } from "@/src/actions/rates";
      ...
      exchangeRates: {
        ...
        data:
          exchangeRatesResult.status === "fulfilled"
            ...
            : null,
        error:
          exchangeRatesResult.status === "rejected"
            ? exchangeRatesResult.reason
            : null,
      },
    };

    const allSuccessful =
      results.institutions.success && results.exchangeRates.success;
