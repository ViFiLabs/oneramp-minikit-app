...
export function BuyPanelErrorFallback({
  ...
  return (
    <div className="mx-auto w-full bg-[#181818] text-white rounded-3xl overflow-hidden p-4 sm:p-5 min-h-[400px] space-y-4">
      <div className="rounded-2xl border border-amber-500/30 bg-amber-500/10 px-4 py-2 text-xs sm:text-sm text-amber-200">
        Buy is temporarily unavailable. Inputs are paused while service recovers.
      </div>
