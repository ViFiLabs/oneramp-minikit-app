...
export function KYCVerificationModal({ open }: KYCVerificationModalProps) {
  const { setIsCheckingKyc, clearKycData, setShowKYCModal } = useKYCStore();
  const { address } = useWalletGetInfo();
  const { isPolling, isInDelayedPhase, refetchKYC } = useKYCStatus();
