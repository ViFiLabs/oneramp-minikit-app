...
export const metadata: Metadata = {
  title: "Terms of Use | VIFI Holdings - Oneramp.io",
  description: "Read the terms of use for VIFI Holdings services including Oneramp.io and Oneramp Protocol. Understand your rights and responsibilities when using our decentralized financial services.",
  keywords: ["terms of use", "VIFI Holdings", "Oneramp.io", "cryptocurrency", "DeFi", "blockchain"],
  robots: "index, follow",
  openGraph: {
    title: "Terms of Use | VIFI Holdings",
    description: "Terms of use for VIFI Holdings services including Oneramp.io and Oneramp Protocol",
    type: "website"
  }
};
